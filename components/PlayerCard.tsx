...
export function PlayerCard({ player }: { player: Player | null }) {
    ...
    return (
        <div className="flex flex-col items-center pt-12 w-full h-full bg-[#1D1D1D] rounded-lg overflow-hidden">
            ...
            <div className="w-full flex-1 bg-[#2F2F2F] rounded-t-lg flex flex-col items-center justify-start">
                ...
                <div className="w-full h-4 text-[16px] leading-4 text-white/80 text-center">Points</div>
            </div>
        </div>
    )
}
